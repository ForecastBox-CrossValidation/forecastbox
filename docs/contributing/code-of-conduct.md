...
description: "Community standards for the forecastbox project — based on the Contributor Covenant v2.1."
---
...
We as members, contributors, and leaders pledge to make participation in forecastbox and the NodesEcon community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socioeconomic status, nationality, personal appearance, race, caste, color, religion, or sexual identity and orientation.
...
This Code of Conduct applies within all NodesEcon project spaces — including the GitHub repository, issue tracker, discussion forums, and pull requests — and also applies when an individual is officially representing the project in public spaces.
...
This Code of Conduct also applies across all NodesEcon ecosystem packages, including forecastbox, chronobox, kalmanbox, archbox, and panelbox.
